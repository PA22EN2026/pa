class Mi_Clase:
    ...
    def sumar(self):
        resultado = self._num1 + self.num2 + self._num3
        print("Suma:", resultado)

    def mayor(self):
        mayor = max(self._num1, self.num2, self._num3)
        print("Mayor:", mayor)

    def menor(self):
        menor = min(self._num1, self.num2, self._num3)
        print("Menor:", menor)

    def iguales(self):
        if self._num1 == self.num2 == self._num3:
            print("Son iguales")
        else:
            print("No son iguales")

    def concatenar(self):
        texto = str(self._num1) + str(self.num2) + str(self._num3)
